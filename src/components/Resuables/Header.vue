<template>
  <div class="relative w-full bg-white">
    <div
      class="mx-auto flex items-center justify-between px-4 py-2 sm:px-6 lg:px-8"
    >
      <div class="inline-flex items-center space-x-2">
        ...
        <span class="font-bold">Fortuna</span>
      </div>
      ...
      <div class="flex px-2">
        <p class="font-bold">{{ logedInUserEmail }}</p>
        <span class="px-2">|</span>
        <span
          @click="logout"
          class="mdi mdi-logout-variant text-xl cursor-pointer"
        >
          <svg
            class="w-6 h-6 text-gray-800 dark:text-gray-800"
            aria-hidden="true"
...
onBeforeMount(() => {
  logedInUserEmail.value = sessionStorage.getItem("logedInUser");
});
</script>
